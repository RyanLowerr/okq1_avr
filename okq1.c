...
int main(void)
{
	...
	{		
		...
		leg_angles[0].coxa   = (uint16_t) (AX_CENTER_VALUE + (leg_angles[0].coxa   - COXA_ZERO)   * 3.41);
		leg_angles[0].femur  = (uint16_t) (AX_CENTER_VALUE + (leg_angles[0].femur  + FEMUR_ZERO)  * 3.41);
		leg_angles[0].tibia  = (uint16_t) (AX_CENTER_VALUE - (leg_angles[0].tibia  - TIBIA_ZERO)  * 3.41);
		leg_angles[0].tarsus = (uint16_t) (AX_CENTER_VALUE - (leg_angles[0].tarsus + TARSUS_ZERO) * 3.41);
		
		leg_angles[1].coxa   = (uint16_t) (AX_CENTER_VALUE + (leg_angles[1].coxa   - COXA_ZERO)   * 3.41);
		leg_angles[1].femur  = (uint16_t) (AX_CENTER_VALUE + (leg_angles[1].femur  + FEMUR_ZERO)  * 3.41);
		leg_angles[1].tibia  = (uint16_t) (AX_CENTER_VALUE - (leg_angles[1].tibia  - TIBIA_ZERO)  * 3.41);
		leg_angles[1].tarsus = (uint16_t) (AX_CENTER_VALUE - (leg_angles[1].tarsus + TARSUS_ZERO) * 3.41);
		
		leg_angles[2].coxa   = (uint16_t) (AX_CENTER_VALUE + (leg_angles[2].coxa   - COXA_ZERO)   * 3.41);
		leg_angles[2].femur  = (uint16_t) (AX_CENTER_VALUE + (leg_angles[2].femur  + FEMUR_ZERO)  * 3.41);
		leg_angles[2].tibia  = (uint16_t) (AX_CENTER_VALUE - (leg_angles[2].tibia  - TIBIA_ZERO)  * 3.41);
		leg_angles[2].tarsus = (uint16_t) (AX_CENTER_VALUE - (leg_angles[2].tarsus + TARSUS_ZERO) * 3.41);
		
		leg_angles[3].coxa   = (uint16_t) (AX_CENTER_VALUE + (leg_angles[3].coxa   - COXA_ZERO)   * 3.41);
		leg_angles[3].femur  = (uint16_t) (AX_CENTER_VALUE + (leg_angles[3].femur  + FEMUR_ZERO)  * 3.41);
		leg_angles[3].tibia  = (uint16_t) (AX_CENTER_VALUE - (leg_angles[3].tibia  - TIBIA_ZERO)  * 3.41);
		leg_angles[4].tarsus = (uint16_t) (AX_CENTER_VALUE - (leg_angles[3].tarsus + TARSUS_ZERO) * 3.41);
